...
void test_pqueue_empty() {
    ...
    CUBE_PRINT(!receivedSuccessfully, "Receiving from empty PQueue succeeded");
}
...
void test_pqueue_current_count() {
    ...
    CUBE_PRINT(count == 3, "Incorrect count in PQueue");
}
...
void test_pqueue_max_depth() {
    ...
    CUBE_PRINT(maxDepth == 5, "Incorrect max depth in PQueue");
}
